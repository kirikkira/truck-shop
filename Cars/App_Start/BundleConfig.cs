...
namespace Cars
{
	public class BundleConfig
	{
		...
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			bundles.Add(new ScriptBundle("~/bundles/CarsJS").Include(
						"~/Scripts/Controllers/cars.js"));
			...
			bundles.Add(new ScriptBundle("~/bundles/BuyJs").Include(
						"~/Scripts/Controllers/BuyCar.js"));
		}
	}
}